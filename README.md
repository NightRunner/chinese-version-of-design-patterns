...
### [代理模式(proxy)](proxy/src/main/java/person/nightrunner/静态代理模式主程序.java)动态代理([JDK](proxy/src/main/java/person/nightrunner/动态代理模式主程序_JDK.java)[Cglib](proxy/src/main/java/person/nightrunner/动态代理模式主程序_CGLIB.java))
